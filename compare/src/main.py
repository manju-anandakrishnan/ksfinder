...
from prepare_data import LinkPhinderData, PredKinKGData, KSAtlas
...
def process():
    ...
    # print('Loading k-s atlas prediction data---',flush=True)
    # KSAtlas.load_predictions()
    print('Assessment 9---',flush=True)
    assessment9 = Assessment(g_constants.ASSESS9_DATA_PATH)
    assessment9.run(o_class=True)
